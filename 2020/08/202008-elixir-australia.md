...
^
Tonight is lightning talk night, so have the following pairs of talks.

---
[.hide-footer]

![left](https://www.dropbox.com/s/3evfqmrayqrq8x1/rhiana-heath.jpg?dl=1)
...
^
First up, Rhiana will be going through the exercism Armstrong numbers exercise from the perspective of an Elixir beginner.

---
[.hide-footer]

![right](https://www.dropbox.com/s/2xz2otjzu8a53uk/cam-stuart.jpg?dl=1)
...
^
Next up, we'll have Cam Stuart doing a talk about Trading Cryptocurrency with Elixir, focusing on capturing real time websocket data, transforming it into structs, and persisting it in Erlang term storage.

---

![inline 3%](https://www.dropbox.com/s/am5fvlc37x3t6jm/Twitter_logo_bird_transparent_png.png?dl=1)

# [fit] `@RhianaHeath` **/** `@cam_stuart`
# [fit] **`@ElixirSydney`**
# [fit] **`@ElixirMelbourne`**
...
# [fit] **ISBN Verifier**
### *`exercism download --exercise=isbn-verifier --track=elixir`*

^
The ISBN-10 verification process is used to validate book identification numbers, so your task is to write something like it to check if a given string is a valid ISBN-10 number.
