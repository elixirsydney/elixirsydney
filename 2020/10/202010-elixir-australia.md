...
![left](https://www.dropbox.com/s/ftzkfw2cctqdros/ryan-pauley.jpg?dl=1)
...
^
Working on some electronics, Ryan needed a resistor calculator and he wanted to bootstrap a command line tool for quick use - disliking to mouse through website forms.<br />
He decided to use an escript to make a command-line executable, quickly. It was easy and did the job in the ecosystem he wanted.<br />
After the fact, he realized that escripts weren't without their issues, so really, his talk is a way to spend a bit of time to learn some of those edges and share the experience, the pros, and the cons of Elixir escripts.

---
[.hide-footer]

![left](https://www.dropbox.com/s/svfk1mfhxa4oy85/robin-hilliard.png?dl=1)
...
^
Next, Robin will do a nice compact answer to the Exercism ISBN Verifier challenge. Then for those of you curious about other loosely typed LISP-like languages (e.g. Clojure) we'll rewrite it in Robert Virding's LFE (LISP Flavoured Erlang). After the rioting subsides we will close with a reminder that we're all part of one big happy BEAM family by looking at the surprisingly understandable BEAM VM assembly code generated by the Elixir/LFE/Erlang build chain.

---

![inline 3%](https://www.dropbox.com/s/am5fvlc37x3t6jm/Twitter_logo_bird_transparent_png.png?dl=1)

# [fit] `@ryapauley` **/** `@robinhilliard`
# [fit] **`@ElixirSydney`**
# [fit] **`@ElixirMelbourne`**
