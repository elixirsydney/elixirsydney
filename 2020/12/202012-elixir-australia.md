...
^
Julian is going to give us a talk about how we can abuse macros and Elixir type specs to build a DSL that sort of gives us some of the same conciseness and elegance of Haskell.
...
^
Qing is going to talk about Elixir's bitwise functions and in what situations they can be useful and performant.

---

![inline 3%](https://www.dropbox.com/s/am5fvlc37x3t6jm/Twitter_logo_bird_transparent_png.png?dl=1)

# [fit] `@madlep` / `@wiserfirst`
# [fit] **`@ElixirSydney`**
# [fit] **`@ElixirMelbourne`**
...
# [fit] Next Meetup
# [fit] **February 17, 2021**
# [fit] *\(3rd Wednesday of the month\)*

^
The next meetup will be next year, February 17, 2021, still online for the foreseeable future, but I guess we'll see what happens.
