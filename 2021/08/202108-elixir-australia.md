...
# [fit] **procedural code**
# [fit] to **Elixir** -
# [fit] what could go wrong?
# [fit] _Mike Buhot_
# [fit] **`@MikeBuhot`**

^
Mike will share his experience of solving the 'Goonerism Spenerator' puzzle in typescript, and porting the resulting code to Elixir.
...
# [fit] Next Meetup
# [fit] **September 15, 2021**
# [fit] _\(3rd Wednesday of the month\)_

^
The next meetup will be on September 15, 2021, live online from lockdown.
