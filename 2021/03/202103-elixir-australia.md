...
# [fit] Kicking the tyres
# [fit] on **Nx**
# [fit] **__(Numerical Elixir)__**
# [fit] *Robert Ellen*
# [fit] **`@robertellen`**

^
NX is the newest bleeding edge hotness in Elixir, and Robert will go through what it is, what it can it be used for, and give us a Demo
...
^
Julian is going to do a lightning talk on his solution to the Exercism problem Pig Latin, and show you all how you can hide your conversations from adults.
...
^
Correctly determine change to be given using the least number of coins, a great problem for junior developers and/or small business owners to try.
