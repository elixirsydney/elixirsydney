...
![right](https://www.dropbox.com/s/1ybhgzwi15medlr/matt-platts.jpg?dl=1)

# [fit] **Building** a
# [fit] HEEX
# [fit] **components library**
# [fit] _Matt Platts_
# [fit] **_`@mplatts`_**

^
Matt is going to talk about How to build a HEEX component, how to manage a component library for them in your project, and show off Petal Components as an example library.
...
^
Theo will talk about how his onboarding as a technical consultant at Alembic involved picking apart and reconstructing the popular browser-based language game Wordle.
